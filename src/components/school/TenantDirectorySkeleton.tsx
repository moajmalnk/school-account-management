...
/** Matches Settings → Fees (categories + periods list) while tenant store hydrates. */
export function TenantFeesSkeleton() {
  return (
    <div
      className="space-y-4 sm:space-y-5"
      aria-busy="true"
      aria-live="polite"
      aria-label="Loading fee settings"
    >
      {/* Fee Categories card */}
      <section className={cn(glassCardClass, "rounded-2xl p-4 sm:p-5")}>
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 space-y-2">
            <Bone className="h-5 w-36 rounded-md sm:h-6 sm:w-44" />
            <Bone className={cn("h-3 w-52 rounded-md sm:w-64", boneSoft)} />
          </div>
          <Bone className="h-9 w-[4.5rem] shrink-0 rounded-full" />
        </div>
            ...
            >
              <div className="flex min-w-0 flex-1 items-center gap-2.5">
                ...
                <div className="min-w-0 flex-1 space-y-1.5">
                  ...
                  <Bone className={cn("h-2.5 w-14 rounded-md", boneSoft)} />
                </div>
              </div>
      ...
      <section className={cn(glassCardClass, "rounded-2xl p-4 sm:p-5")}>
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 space-y-2">
            <Bone className="h-5 w-32 rounded-md sm:h-6 sm:w-40" />
            <Bone className={cn("h-3 w-56 rounded-md sm:w-72", boneSoft)} />
          </div>
          <Bone className="h-9 w-[4.5rem] shrink-0 rounded-full" />
        </div>
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
          {Array.from({ length: 2 }).map((_, col) => (
            <div key={col} className="min-w-0">
              <Bone className={cn("mb-2 h-2.5 w-12 rounded-md", boneSoft)} />
              <div className="flex border-b border-[#E8E8EA] pb-px">
                {Array.from({ length: 3 }).map((_, i) => (
              ...
              <div className="flex min-w-0 flex-1 items-center gap-2.5">
                ...
                <div className="min-w-0 flex-1 space-y-1.5">
                  <div className="flex flex-wrap items-center gap-1.5">
                    ...
                    <Bone className={cn("h-5 w-24 rounded-full", boneSoft)} />
                  </div>
                  <Bone className={cn("h-2.5 w-[70%] max-w-xs rounded-md", boneSoft)} />
                </div>
              </div>
              <div className="flex shrink-0 items-center gap-1">
                <Bone className={cn("hidden h-3 w-10 rounded-md sm:block", boneSoft)} />
                <Bone className="h-8 w-8 rounded-full" />
                <Bone className="h-8 w-8 rounded-full" />
              </div>
            </div>
