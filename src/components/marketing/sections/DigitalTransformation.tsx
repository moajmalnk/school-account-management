        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl border border-[var(--mkt-line)] bg-gradient-to-br from-white to-[#f4faf1] p-8 shadow-sm flex flex-col min-h-[340px]">
            ...
            <div className="flex flex-col gap-2.5 mt-auto">
              {[
                ...
                <div key={pill} className="inline-flex items-center px-3 py-1.5 bg-white border border-[var(--mkt-line)] rounded-full text-[11px] font-medium text-[var(--mkt-ink)] shadow-[0_1px_2px_rgba(0,0,0,0.02)] w-max max-w-full truncate">
                  {pill}
                </div>
              ))}
            </div>
          ...
          <div className="rounded-3xl border border-[var(--mkt-line)] bg-[#f6fbf4] p-8 shadow-sm flex overflow-hidden relative min-h-[340px]">
            <div className="relative z-10 w-[55%] flex flex-col">
              ...
              <div className="flex flex-col gap-2 mt-auto">
                <div className="inline-flex items-center justify-between px-3 py-1.5 bg-[var(--mkt-green)] text-white text-[11px] font-medium rounded-md w-fit min-w-[100px]">
                  <span>Overdue</span> <span className="ml-2 font-bold">→</span>
                </div>
                <div className="inline-flex items-center justify-between px-3 py-1.5 bg-[var(--mkt-green)] text-white text-[11px] font-medium rounded-md w-fit min-w-[120px]">
                  <span>Bulk WhatsApp</span> <span className="ml-2 font-bold">→</span>
                </div>
                <div className="inline-flex items-center justify-center px-3 py-1.5 bg-[var(--mkt-green)] text-white text-[11px] font-medium rounded-md w-fit min-w-[70px]">
                  <span>Send</span>
                </div>
              </div>
            </div>
            
            <div className="absolute right-0 bottom-0 top-[20%] w-[55%]">
               <img src="/digital/1.png" alt="Phone interface" className="w-full h-full object-contain object-right-bottom drop-shadow-xl translate-x-2 translate-y-4 scale-[1.15]" />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 h-full">
            ...
            <div className="rounded-3xl border border-[var(--mkt-line)] bg-white p-6 shadow-sm flex items-start justify-between flex-1 min-h-[160px]">
              ...
              <div className="w-[80px] h-[80px] rounded-2xl border border-[var(--mkt-line)] bg-white flex items-center justify-center flex-shrink-0 shadow-sm ml-4 mt-2">
                <div className="w-10 h-10 rounded-full bg-[var(--mkt-green)] flex items-center justify-center shadow-inner">
            ...
            <div className="rounded-3xl border border-[var(--mkt-line)] bg-white p-6 shadow-sm flex flex-col justify-between flex-1 min-h-[190px]">
              <div>
                 ...
                 <p className="text-[12px] text-[var(--mkt-muted)] mb-6 ml-9">
              ...
              <div className="flex items-end justify-between w-full pl-9 pr-2">
                <div>
                   <div className="text-[28px] font-bold text-[var(--mkt-ink)] leading-none tracking-tight">23500</div>
          ...
          <div className="rounded-3xl border border-[var(--mkt-line)] bg-white shadow-sm flex flex-col relative overflow-hidden h-full min-h-[374px]">
            ...
            <div className="flex-1 w-full bg-white relative mt-2 flex items-end justify-center">
               <img src="/digital/2.png" alt="Staff stats chart" className="w-[85%] max-h-[100%] object-contain object-bottom drop-shadow-[0_4px_12px_rgba(0,0,0,0.05)]" />
            </div>
          </div>
        </div>
