...
export function StoreBadge({
  ...
  return (
    <motion.a
      ...
      className={cn(
        "inline-flex h-[46px] w-full min-w-[152px] max-w-[168px] items-center gap-2.5 rounded-xl px-3.5 text-white shadow-[0_8px_24px_rgba(143,202,74,0.28)] transition-colors",
        isPlay
    ...
    >
      {isPlay ? (
        <svg className="h-6 w-6 shrink-0 fill-current" viewBox="0 0 24 24" aria-hidden>
