...
/** How often to ask the SW / version.json if a new deploy is live. */
...
export function PwaUpdateToast() {
  ...
  const {
    ...
    onRegisteredSW(_swUrl, registration) {
      ...
      // First check shortly after load, then on an interval.
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "sm:bottom-5 sm:px-4",
        "md:left-auto md:right-5 md:translate-x-0 md:max-w-[400px] md:px-0",
      )}
    >
        ...
        <div className="flex items-start gap-3 p-3.5 sm:p-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-[12.5px] leading-snug text-slate-500 dark:text-zinc-400">
              A fresh update was deployed. Reload now to avoid stale screens and old
              data.
            </p>
