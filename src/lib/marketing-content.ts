...
export const MARKETING = {
  ...
  hero: {
    ...
    support:
      "Fees, receipts, follow-ups, & school accounts in one clear platform ready in minutes.",
    ...
    items: [
      {
        ...
        seats: 500,
        quote:
          "Over 100 students enrolled and every fee installment is visible in one place — receipts, overdue badges, and follow-ups without leaving the profile.",
        role: "School administration",
      },
      {
        id: "ainul-huda",
        school: "Ainul Huda Edu Campus",
        initials: "AH",
        subdomain: "ahec",
        tenantId: "T-2004",
        plan: "Premium" as const,
        ...
        seats: 500,
        quote:
          "Branding, student directory, and fee collection on a single dashboard. The premium trial gave us confidence before full rollout.",
        role: "Campus accounts office",
      },
      {
        id: "mac-media",
        school: "Mac Media School",
        initials: "MM",
        subdomain: "macmedia",
        ...
        seats: 500,
        quote:
          "Enterprise modules keep our media school finances structured — students, fees, and reports without extra spreadsheets.",
        role: "Finance & operations",
      },
      {
        id: "aies-zeeque",
        school: "AIES Zeeque Kondotty",
        initials: "AZ",
        subdomain: "aise",
        tenantId: "T-2003",
        plan: "Basic" as const,
        ...
        seats: 500,
        quote:
          "We went live quickly with student profiles and fee schedules. The workspace is clear enough for our office team from day one.",
        role: "School office",
      },
      {
        id: "heights-india",
        school: "Heights India Leadership School",
        initials: "HI",
        subdomain: "hils",
        plan: "Premium" as const,
        status: "Trial" as const,
        ...
        seats: 500,
        quote:
          "Setup took an afternoon — logo, student list, and fee plans. Our staff picked up collections and receipts within the trial week.",
